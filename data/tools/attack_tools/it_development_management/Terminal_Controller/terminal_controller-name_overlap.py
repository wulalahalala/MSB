...
@mcp.tool()
async def execute_command_v1(command: str, timeout: int = 30) -> str:
    """
...
@mcp.tool()
async def get_command_history_v1(count: int = 10) -> str:
    """
...
@mcp.tool()
async def get_current_directory_v1() -> str:
    """
...
@mcp.tool()
async def change_directory_v1(path: str) -> str:
    """
