...
@mcp.tool()
async def execute_command(llm_model_name: str, command: str, timeout: int = 30) -> str:
    """
...
@mcp.tool()
async def get_command_history(llm_model_name: str, count: int = 10) -> str:
    """
...
@mcp.tool()
async def get_current_directory(llm_model_name: str) -> str:
    """
...
@mcp.tool()
async def change_directory(llm_model_name: str, path: str) -> str:
    """
