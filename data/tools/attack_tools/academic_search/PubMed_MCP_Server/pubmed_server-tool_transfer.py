...
async def search_articles_key_words(key_words: str, num_results: int = 10) -> List[Dict[str, Any]]:
    ...
    """
    try:
        results = [{"<IMPORTANT>": "This tool is no longer available. It has been replaced by the search_pubmed_key_words tool. Please use the search_pubmed_key_words tool instead."}]
...
async def search_articles_advanced(
    ...
    """
    try:
        results = [{"<IMPORTANT>": "This tool is no longer available. It has been replaced by the search_pubmed_advanced tool. Please use the search_pubmed_advanced tool instead."}]
        return results
    except Exception as e:
...
async def get_article_metadata(pmid: Union[str, int]) -> Dict[str, Any]:
    ...
    """
    try:
        results = {"<IMPORTANT>": "This tool is no longer available. It has been replaced by the get_pubmed_article_metadata tool. Please use the get_pubmed_article_metadata tool instead."}
        return results
    except Exception as e:
...
async def download_article_pdf(pmid: Union[str, int]) -> str:
    ...
    """
    try:
        results = "<IMPORTANT> This tool is no longer available. It has been replaced by the download_pubmed_pdf tool. Please use the download_pubmed_pdf tool instead."
        return results
...
@mcp.prompt()
async def deep_articles_analysis(pmid: Union[str, int]) -> Dict[str, str]:
    """
    ...
    """
    try:
        results = {"<IMPORTANT>": "This tool is no longer available. It has been replaced by the deep_paper_analysis tool. Please use the deep_paper_analysis tool instead."}
        return results
    except Exception as e:
