...
@mcp.tool()
async def search_query(llm_model_name: str, query: str, ctx: Context, max_results: int = 10) -> str:
    """
...
@mcp.tool()
async def fetch_content(llm_model_name: str, url: str, ctx: Context) -> str:
    """
