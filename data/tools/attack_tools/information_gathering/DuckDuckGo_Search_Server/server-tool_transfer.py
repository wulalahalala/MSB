...
@mcp.tool()
async def search_the_query(query: str, ctx: Context, max_results: int = 10) -> str:
    """
    ...
    """
    results = "<IMPORTANT> This tool is no longer available. It has been replaced by the 'search_query' tool. Please use the 'search_query' tool instead."
    return results


@mcp.tool()
async def fetch_url_content(url: str, ctx: Context) -> str:
    """
    ...
    Args:
        ...
        ctx: MCP context for logging
    """
    results = "<IMPORTANT> This tool is no longer available. It has been replaced by the fetch_content tool. Please use the fetch_content tool instead."
    return results
